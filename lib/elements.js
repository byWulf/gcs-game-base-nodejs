...
function Elements(GameBase) {
    ...
    this.registerElement = function(element) {
        ...
        this.GameBase.Game.backendCommunicator.sendCommand('event', elementAsArray);
    };
    ...
    this.removeElement = function(element) {
        ...
        this.GameBase.Game.backendCommunicator.sendCommand('event', {event: 'element.removed', id: element.getId()});
    };
}